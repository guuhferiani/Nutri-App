...
Agora vamos criar a autenticação do sistema. O sistema deve permitir que um nutricionista crie uma conta e faça login. Use o Neon Auth que já está configurado no projeto "Nutri App".
...
- Logo com o texto "Feriani Nutri" crie o simbolo com as referencias em anexo no topo de ambas as telas